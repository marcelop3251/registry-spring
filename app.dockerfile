...
COPY /registry-spring/agent/jmx_prometheus_javaagent-0.15.0.jar /opt/app
COPY /registry-spring/agent/config.yaml /opt/app
COPY /registry-spring/build/libs/registry-spring-1.0.0.jar /opt/app/app.jar
